      ...
      <div className="pt-10 bg-[#F4F2EC]">
        ...
        <div className="flex w-full h-[500px] pt-5">
          <div className="flex flex-col justify-center h-full w-[40vw] pl-[3vw]">
            <h1 className="text-[6vw] font-semibold text-black">Find The Job For You</h1>
            <p className="mt-[5px] text-[1.5vw] text-black">Connecting Daily Labor with Daily Work: Your Path to Opportunity Starts Here</p>
        ...
        <div className="flex flex-col items-center justify-center h-[167px]">
          ...
          <div className="flex mt-5 gap-[45px] text-black">
        ...
        <div className="flex flex-col items-center">
          ...
          <div className="flex">
            <div className="flex flex-col justify-center px-[5vw] pr-[15vw]">
              <p className="text-[1.5vw] text-black">Discover skilled daily laborers swiftly and efficiently through our platform at RojPagar. Streamline your hiring process and connect with reliable workers ready to tackle any task. Find the right fit for your job needs today!</p>
              <button className="w-[13vw] p-[1.5vw] ml-[2vw] mt-5 bg-black text-white font-bold">Post Jobs Now</button>
            </div>
            <Image
              src="/assets/hireBanner.svg"
              alt="Hire Banner"
              width={600}
              height={400}
              className="pr-[3vw]"
