    ...
    <>
      <div className="bg-[#F4F2EC] w-screen h-screen relative">
        <Image 
          ...
          width={150} 
          height={80} 
          className='absolute w-[10vw] top-5 left-2' 
        />
          ...
          <form onSubmit={handleSubmit} className="bg-white absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 p-10 rounded-xl shadow-md overflow-y-auto max-h-[90vh] w-[70vw]">
            ...
            <div className="w-full flex items-center justify-center pt-5">
              <button
                ...
                className="bg-black text-white px-7 py-2 rounded-full text-lg hover:bg-gray-800 transition duration-200 flex items-center disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
                  <>
